...
const ContactDetails = () => (
  <div className="flex flex-col items-center lg:items-start gap-4 lg:gap-6 w-full">
    ...
    {/* ⬇️ FONT SIZE REDUCED BY 1 STEP ONLY HERE */}
    <div className="flex flex-col items-center lg:items-start gap-4 w-full overflow-hidden text-[#9D29C6] text-[1rem] md:text-[1.05rem] lg:text-[1.1rem] font-medium">
      ...
      {/* ✅ Email (redirectable, whole line clickable, single line) */}
      <a
        href="mailto:contact@laxmishreeinvestment.com"
        className="flex items-center gap-2 min-w-0 w-full justify-center lg:justify-start hover:underline no-underline"
        title="contact@laxmishreeinvestment.com"
      >
        <span className="shrink-0">Email:</span>
        <span className="flex-1 min-w-0 truncate">
        contact@laxmishreeinvestment.com
        </span>
      </a>

      {/* WhatsApp (redirectable) */}
      <a
  ...
  const faqItems = [
    {
      ...
      answer:
        "We offer Primary Share Investments, Secondary Market Trading, Right Share Investment, Portfolio Management, Market Research & Analysis, and Risk Assessment & Advisory.",
    },
    {
      question: "How do I get started as a new investor?",
      answer:
        "Simply reach out through our contact form, email, or visit our office. Our team will guide you through account opening, KYC, and investment planning.",
    },
    {
      question: "Can I invest if I am new to the stock market?",
      answer:
        "Absolutely. Our experts provide step-by-step guidance, from understanding IPOs and right shares to building your first portfolio.",
    },
    {
      question: "How do you decide which investment is right for me?",
      answer:
        "We assess your financial goals, risk appetite, and time horizon before recommending a customized investment strategy.",
    },
    {
      question: "Do you help with portfolio diversification?",
      answer:
        "Yes. We design diversified portfolios across various asset classes to balance risk and return.",
    },
    {
      question: "What are the risks of investing?",
      answer:
        "All investments carry some risk. Our role is to identify, minimize, and manage risks through expert advisory and research-backed strategies.",
    },
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col items-center gap-8 md:gap-12 lg:gap-16 xl:gap-20">
              ...
              <div className="flex flex-col items-center md:items-start gap-6 md:gap-8 w-full">
                ...
                {/* Mobile */}
                <div className="lg:hidden flex flex-col gap-6 md:gap-8 w-full">
